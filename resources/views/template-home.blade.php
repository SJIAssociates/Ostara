  ...
  <div class='container flex flex-col justify-center'>
    <div class='flex'>
      <div class='w-full md:w-1/2'>
        ...
        <p class='text-white text-2xl lg:text-4xl text-center font-medium'>We offer transformational<br>problem-solving.</p>
      </div>
    </div>
  </div>
</section>
...
<section class='relative' id='homeInfo'>
  ...
  <div class='container flex flex-col justify-center py-5 lg:py-24'>
    ...
    <div class='w-full relative lg:py-24 min-h-screen'>
      <div class='w-full lg:w-1/2'>
        <h2 class='leading-normal text-blue-dark text-2xl lg:text-4xl lg:mt-32'>We partner exclusively with open-minded, creative, courageous leaders and entrepreneurs.</h2>
      </div>
    </div>
  </div>
